# TODO: 引入 discord API 的套件
# 可惡的翻譯蒟蒻: import discord  
...
@bot.event
# TODO: 這是一個接受到訊息會觸發的事件
# 可惡的翻譯蒟蒻: async def 當訊息時(message):
    """當收到訊息時觸發的事件"""
    ...
    # 可惡的翻譯蒟蒻: if 玩家發出的訊息 == "?good":
        ...
        # TODO: 在這則訊息添加一個「👍」的反應
        # 可惡的翻譯蒟蒻: await bot.message_wait_for_reaction.新增表情符號的函式("👍")

@bot.event
# TODO: 這是一個接受到表情符號會觸發的事件
# 可惡的翻譯蒟蒻: async def 當反應新增時(reaction, user):
    """當收到訊息時觸發的事件"""
...
@bot.event
# TODO: 這是一個接受到表情符號會觸發的事件
# 可惡的翻譯蒟蒻: async def 當反應移除(reaction, user):
    """當使用者移除反應時觸發"""
